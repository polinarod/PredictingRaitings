...
def get_rating(filename,mode='ratings'):
    ...
    reject_ser = pd.read_csv(r'/Users/admin/Desktop/Polina/PredictingRatings-master/data/reject_columns.csv', header=None)
    reject = reject_ser[0].tolist()
    features = features.drop(columns=reject)

    features.columns = [x for x in range(224)]
    reject_ser1 = pd.read_csv(r'/Users/admin/Desktop/Polina/PredictingRatings-master/data/reject_cols.csv', header=None)
    ...
    with open('/Users/admin/Desktop/Polina/PredictingRatings-master/kmeans1.pkl', 'rb') as f:
        kmeans1 = pickle.load(f)

    cluster=int(kmeans1.predict(elos)[0])+1

    if cluster==1:
        with open('/Users/admin/Desktop/Polina/PredictingRatings-master/lr_cl1_mean.pkl', 'rb') as f:
            model_mean = pickle.load(f)
        with open('/Users/admin/Desktop/Polina/PredictingRatings-master/lr_cl1_diff.pkl', 'rb') as f:
            model_diff = pickle.load(f)

    elif cluster==2:
        with open('/Users/admin/Desktop/Polina/PredictingRatings-master/lr_cl2_mean.pkl', 'rb') as f:
            model_mean = pickle.load(f)

        with open('/Users/admin/Desktop/Polina/PredictingRatings-master/lr_cl2_diff.pkl', 'rb') as f:
            model_diff = pickle.load(f)

    elif cluster==3:
        with open('/Users/admin/Desktop/Polina/PredictingRatings-master/rf_cl3_mean.pkl', 'rb') as f:
            model_mean = pickle.load(f)
        with open('/Users/admin/Desktop/Polina/PredictingRatings-master/rf_cl3_diff.pkl', 'rb') as f:
            model_diff = pickle.load(f)

    elif cluster==4:
        with open('/Users/admin/Desktop/Polina/PredictingRatings-master/svm_cl4_mean.pkl', 'rb') as f:
            model_mean = pickle.load(f)
        with open('/Users/admin/Desktop/Polina/PredictingRatings-master/svm_cl4_diff.pkl', 'rb') as f:
            model_diff = pickle.load(f)
    else:
...
#ratings=get_rating(filename,'ratings')
#print(ratings)
